  ...
  return (
    <Card variant='default' className='w-full max-w-md mx-auto'>
      <CardHeader className='text-center'>
        ...
        <CardDescription>Sign in to your Dashboard Link account</CardDescription>
      </CardHeader>
    ...
    <Modal open={isOpen} onOpenChange={onOpenChange}>
      <ModalContent className='sm:max-w-md'>
        <ModalHeader>
          ...
          <ModalDescription>Sign in to your account or create a new one</ModalDescription>
        </ModalHeader>
  ...
  return (
    <Card variant='default' className='w-full max-w-md mx-auto'>
      <CardHeader className='text-center'>
        ...
        <CardDescription>Start your free trial of Dashboard Link</CardDescription>
      </CardHeader>
