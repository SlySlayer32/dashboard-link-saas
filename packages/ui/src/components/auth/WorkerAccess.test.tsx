...
describe('WorkerAccess', () => {
  ...
  describe('Content Messages', () => {
    ...
    it('should show appropriate expired message', () => {
      ...
      expect(screen.getByText('This dashboard link has expired')).toBeInTheDocument()
      expect(
        screen.getByText('Dashboard links expire after a certain time for security')
      ).toBeInTheDocument()
    })
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long error messages', () => {
      const longError =
        'This is a very long error message that should still be displayed properly in the UI without breaking the layout or causing any visual issues'
