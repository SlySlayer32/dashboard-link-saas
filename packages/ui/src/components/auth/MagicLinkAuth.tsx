    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
      <Card className='w-full max-w-md mx-4'>
        ...
        <CardContent>
          <Tabs
            value={activeTab}
            onValueChange={(value) => setActiveTab(value as 'login' | 'magic-link' | 'signup')}
          >
            ...
            <TabsContent value='magic-link' className='mt-6'>
              <div className='text-center mb-6'>
                ...
                <p className='text-sm text-gray-600'>
                  Get a secure link sent to your email. No password needed.
                </p>
              </div>
              ...
              {!magicLinkData.sent ? (
                <form onSubmit={handleMagicLink} className='space-y-4'>
                  <Input
                    ...
                    onChange={(e) =>
                      setMagicLinkData((prev) => ({ ...prev, email: e.target.value }))
                    }
                    required
                    disabled={isLoading}
                  />
            ...
            <TabsContent value='signup' className='mt-6'>
              <form onSubmit={handleSignup} className='space-y-4'>
                <Input
                  ...
                  onChange={(e) =>
                    setSignupData((prev) => ({ ...prev, organization: e.target.value }))
                  }
                  required
                  disabled={isLoading}
                />
                ...
                <div className='flex items-center space-x-2'>
                  <input
                    ...
                    onChange={(e) =>
                      setSignupData((prev) => ({ ...prev, termsAccepted: e.target.checked }))
                    }
                    disabled={isLoading}
