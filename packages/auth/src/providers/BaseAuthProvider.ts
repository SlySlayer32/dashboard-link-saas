  ...
  protected transformUserToAuthUser(user: unknown): AuthUser {
    ...
    return {
      ...
      avatar:
        ...
        ((u.user_metadata as Record<string, unknown>)?.avatar_url as string | undefined),
      role: this.mapRole(
        (u.role as string | undefined) ||
          ((u.user_metadata as Record<string, unknown>)?.role as string | undefined)
      ),
      organizationId:
        (u.organization_id as string | undefined) ||
        ((u.user_metadata as Record<string, unknown>)?.organization_id as string | undefined),
