-- Wrapper migration for Supabase CLI.
-- Source of truth lives in packages/database/migrations.

-- Read and execute the actual migration
-- Note: We need to copy the content here since \i doesn't work with Supabase CLI
