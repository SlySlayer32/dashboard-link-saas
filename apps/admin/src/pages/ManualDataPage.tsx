...
import { useCreateScheduleItem, useDeleteScheduleItem, useScheduleItems, useUpdateScheduleItem } from '../hooks/useScheduleItems';
import type { TaskItem } from '../hooks/useTaskItems';
import { useCreateTaskItem, useDeleteTaskItem, useTaskItems, useUpdateTaskItem } from '../hooks/useTaskItems';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Add schedule items and tasks for your workers
        </p>
      </div>
      ...
      {selectedWorkerId ? (
        <div>
          ...
          <div className="mb-6">
            <button
              onClick={() => activeTab === 'schedule' ? setShowScheduleForm(true) : setShowTaskForm(true)}
