  ...
  return (
    <div className='space-y-4'>
          ...
          <div className='flex'>
            ...
            <div className='ml-3'>
              ...
              <div className='mt-2 text-sm text-green-700'>
                ...
                <p className='mt-1'>Access token: {config.accessToken ? 'Present' : 'Missing'}</p>
                <p>Refresh token: {config.refreshToken ? 'Present' : 'Missing'}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='bg-gray-50 border border-gray-200 rounded-md p-4'>
        <h4 className='text-sm font-medium text-gray-900 mb-2'>OAuth Redirect URI</h4>
