...
export const OnboardingFlow: React.FC = () => {
  ...
  const renderWelcomeStep = () => (
    <div className='max-w-2xl mx-auto text-center py-12'>
      <div className='mb-8'>
        <h1 className='text-4xl font-bold text-gray-900 mb-4'>Welcome to CleanConnect! 🎉</h1>
          ...
          <div className='flex items-start'>
            ...
            <div>
              ...
              <p className='text-blue-700 text-sm'>
                Choose the apps and services you want to integrate
              </p>
            </div>
          </div>
          <div className='flex items-start'>
  ...
  const renderPluginSelectionStep = () => (
    <div className='max-w-6xl mx-auto py-8'>
      <div className='text-center mb-8'>
        <h1 className='text-3xl font-bold text-gray-900 mb-4'>Choose Your Tools</h1>
  ...
  const renderDashboardSetupStep = () => (
    <div className='max-w-4xl mx-auto py-8'>
      <div className='text-center mb-8'>
        <h1 className='text-3xl font-bold text-gray-900 mb-4'>Dashboard Setup</h1>
        <p className='text-lg text-gray-600'>
      ...
      <div className='bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center mb-8'>
        ...
        <h3 className='text-lg font-medium text-gray-700 mb-2'>Drag & Drop Dashboard Builder</h3>
      ...
      <div className='bg-green-50 border border-green-200 rounded-lg p-6 mb-8'>
        <h3 className='text-lg font-semibold text-green-900 mb-4'>✅ Connected Tools:</h3>
