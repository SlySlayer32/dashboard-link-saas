...
export function PluginCard({ plugin, onToggle, onConfigure, onTest, onDelete }: PluginCardProps) {
      ...
      <CardHeader>
        <div className='flex items-start justify-between'>
          <div className='flex items-center space-x-3'>
            <div className='flex-shrink-0 p-2 bg-gray-100 rounded-lg'>{getCategoryIcon()}</div>
            <div>
