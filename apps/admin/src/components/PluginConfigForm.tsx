import type { PluginWithConfig } from '@dashboard-link/shared';
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                The manual plugin doesn't require any configuration. 
                It allows you to manually add tasks and schedules for workers.
              </p>
            </div>
          </div>
        );
