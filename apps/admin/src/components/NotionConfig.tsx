  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='bg-yellow-50 border border-yellow-200 rounded-md p-4'>
        <h4 className='text-sm font-medium text-yellow-800 mb-2'>Database Requirements</h4>
        <p className='text-sm text-yellow-700 mb-2'>
          Your Notion database should include the following properties:
        </p>
        <ul className='list-disc list-inside text-sm text-yellow-700 space-y-1'>
          <li>
            <strong>Title/Name</strong> - Text property for task/schedule name
          </li>
          <li>
            <strong>Due Date</strong> - Date property (required for scheduling)
          </li>
          <li>
            <strong>Worker</strong> - Select or Relation property to assign to workers
          </li>
          <li>
            <strong>Status</strong> - Select property (optional)
          </li>
          <li>
            <strong>Description</strong> - Text or Rich Text property (optional)
          </li>
        </ul>
      </div>
    </div>
