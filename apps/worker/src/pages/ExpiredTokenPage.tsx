    ...
    >
      <div className='space-y-4'>
        ...
        <div className='text-sm text-gray-600'>
          ...
          <p>After expiration, you'll need a new link to access your dashboard.</p>
        </div>

        <div className='bg-yellow-50 border border-yellow-200 rounded-md p-3'>
          <p className='text-sm text-yellow-800'>
            <strong>To get a new link:</strong> Contact your administrator or wait for the daily SMS
            notification.
          </p>
        </div>
        ...
        <div className='bg-gray-50 border border-gray-200 rounded-md p-3'>
          <p className='text-xs text-gray-600'>
            <strong>Tip:</strong> Dashboard links are typically sent daily at the time configured by
            your organization.
          </p>
        </div>
      </div>
