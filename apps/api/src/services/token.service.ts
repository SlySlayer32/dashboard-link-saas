...
export class TokenService {
  ...
  async createToken(
    ...
    // Insert new token using direct insert with type suppression
    ...
    return {
      ...
      expiresAt: newToken?.expires_at || expiresAt,
      workerId: newToken?.worker_id || workerId,
    }
  }
